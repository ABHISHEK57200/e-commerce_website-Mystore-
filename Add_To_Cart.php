...
<!-- <div class="card" style="width: 20rem;">
  ...
  <tbody>
   ...
   ?>
     <!-- <tr>
      <th scope="row"> </th>
      <td><img src="./upload_image/ download.jpeg" alt=""></td>
...
$ip = getIPAddress();
  ...
  <h4 class='px-3'>Subtotals:<strong  class='funtion px-2'> 
   $totalPrice /-
   </strong></h4>
    <input type='submit' value='continue shoping' name='sub' class='  bg-primary border-0 px-3 mb-3 mx-3 '>
   <button class=' bg-secondary border-0 px-3'><a href='checkout.php' class='text-decoration-none text-light text-center'>checkout</a></button>
   </div>";
   }
  else{
    echo "<h3 class='text-center text-info'> cart is empty</h3>";
    echo "<a href='iidex.php'><button class='  bg-primary border-0 px-3 mb-3 mx-5 '>continue shoping</button></a>";
  }
  if(isset($_POST['sub'])){
...
<!-- //   <h4 class="px-3">Subtotals:<strong class="px-2"> -->
    <?php //price_details();?>
<!-- //    </strong></h4> -->
    <!-- <button type="submit"></button>  -->
<!-- //     <a href="iidex.php"><button class=" bg-primary border-0 px-3 mx-3 ">continue shoping</button></a> -->
<!-- //    <a href="#"><button class=" bg-secondary border-0 px-3">checkout</button></a> if the user is logged in then it click this button to redirected on the pament section othe wise got ot iindex page -->
<!-- // </div> -->
