<!-- admin ko ,jo payment complete hua hai usi user ka record show hoga -->
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<body>
    ...
    // $SrNo=1;
    $count=1;
    $select_query="select * from `order` where order_status='complete'";
    ...
    if($count_row>0){
        ...
        while($rows=mysqli_fetch_assoc($result)){
            ...
            // $select_status="select * from `order` where order_stat=$invoice_number";
        ...
        //    while()
           ...
           <td><a href='index.php?delete_payment=$invoice_number'> <i class='fa-solid fa-trash'></i></a></td>";
        $count++;
            }
        }
           ?>
