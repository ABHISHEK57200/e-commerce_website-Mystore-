...
<?php
    ...
    {
        $cattitle=$_POST['brandName'];//currently inserted value
    // select the data from the database
    $select_query="select *from  brand where  brand_title='$cattitle'";
    ...
    $insert_query="insert into `brand`(brand_title) values( '$cattitle')";
...
<form action="" method="POST" class="mt-5">
        ...
        <input type="text" class="form-control " name="brandName" placeholder="insert brand">
        </div>
        <!-- <div class="input-group w-10 mb-2 m-auto">
        <button type="submit" class="bg-info p-2 border-1"> insert</button>
        </div> -->
        <div class="input-group w-10 mb-2 m-auto">
            <input type="submit" name="insert_brand" placeholder="insert" class="bg-info p-2 border-1">
